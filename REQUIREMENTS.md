...
Reproduce the useful parts of a highly customized Ghostty, Helix, Warp, Herdr, OpenCode, Starship, Git, and Zsh environment on another Mac quickly and predictably, without transferring private runtime state or destroying useful configuration already present on the target machine.
...
| R13 | Allow Ghostty, Helix, Warp, Herdr, OpenCode, Starship, Zsh, and Git modules to be initialized and applied independently | Accepted |
