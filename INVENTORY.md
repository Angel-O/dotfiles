...
| `orchestrate.md` | `~/.config/opencode/commands/` | Starts ordinary work under the custom orchestrator with Ponytail-aware delegates | Track when OpenCode is enabled | Shared/conditional |
