...
| `materialize-epic` | Safe materialization of an already approved architecture and planner decomposition into one existing epic; no architecture, planning, worker, or implementation work. Available when Beads and the OpenCode Beads integration are enabled |
